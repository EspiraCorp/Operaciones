...
class ProveedorController extends Controller
{
    ...
    public function editAction(Request $request, $id)
    {
        ...
        if (isset($id)){
	        ...
	        $form = $this->createForm(new ProveedoresedicionType(), $proveedor);
	    }else{
	     	$form = $this->createForm(new ProveedoresedicionType());
	     	$proveedor = new Proveedores();
	    }
     ...
     public function listadoAction()
	{
        ...
        if($pro=($this->get('request')->request->get('proveedores'))){
            $page = 1;
		...
		$form = $this->createForm(new ProveedoresFiltroType($filtros));
